	...
	public String getVisualizationLayout(HttpServletRequest request) {
		...
		try {
			...
			result = "<div class='dxpDataAnalyticswrapper'>"
					...
					+ "<div class='visionChartsAutoSuggestionUserExamplesClass' id='visionChartsAutoSuggestionUserExamplesId'></div>"
					+ "</div>" + "</div>"
					...
					//+ "<li title=\"IntelliSense View\" id=\"li_autoSuggestionsView\" class=\"visionSmartBiDesignTab\"onclick=\"switchSmartBiDesignTabs('li_autoSuggestionsView', 'visionChartAutoSuggestionsViewId')\"><span>IntelliSense View</span></li> \n"
