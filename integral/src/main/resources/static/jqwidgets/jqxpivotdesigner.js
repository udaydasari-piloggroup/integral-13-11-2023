...
(function ($) {
    ...
    $.extend($.jqx._jqxPivotDesigner.prototype, {
        ...
        createInstance: function (args) {
            ...
            host.append("<div class='" + hostClass + "' style='width: 100%; height: 100%; overflow:hidden; onselectstart='return false;' oncontextmenu='return false;''><div class='labelFields jqx-widget' style='position: absolute;'>Pivot Table Fields</div><div class='labelFilters jqx-widget' style='position: absolute;'>Filters</div><div class='labelColumns jqx-widget' style='position: absolute;'>Columns</div><div class='labelRows jqx-widget' style='position: absolute;'>Rows</div><div class='labelValues jqx-widget' style='position: absolute;'>Values</div><div class='divFields' style='position: absolute;'></div><div class='divFilters' style='position: absolute;'></div><div class='divColumns' style='position: absolute;'></div><div class='divRows' style='position: absolute;'></div><div class='divValues' style='position: absolute;'></div></div>");
            this._listBoxes = {
...
//            var pg = '10px';
            ...
            y += textH;
            host.find(".divRows").css({
                left: x,
                top: y
            });
            host.find(".divRows").jqxListBox({
                width: boxWidth,
                height: boxHeight
            });
            host.find(".divValues").css({
                left: x + boxWidth + padding,
                top: y
            });
            host.find(".divValues").jqxListBox({
                width: boxWidth,
                height: boxHeight
            })
        },
                ...
                if (targetElement == lb.fields[0]) {
                    ...
                    if (targetElement == lb.values[0]) {
                        ...
                        for (var i = 0; i < items.length; i++) {
                            lb.values.jqxListBox("updateAt", {
                                label: items[i].label,
                                value: $.extend({}, items[i].value)
                            }, i)
                        }
        ...
        _refreshPivotGrid: function (pivotSourceSettings) {
            ...
            $(self.target.element).jqxPivotGrid({
        ...
        _showDesignerItemContextMenu: function (type, itemIndex) {
            ...
            for (var i in lb) {
                ...
                fieldSettings.moveOperations[self._getLocalizedString("move") + " " + self._getLocalizedString("to") + " " + self._getLocalizedString(i)] = {
                    dropTarget: i
                }
            }
            if (type == "values") {
                ...
                for (var i in availableFunctions) {
                    funcItems[self._getLocalizedString(i)] = {
                        "function": i
                    }
                }
        ...
        _getValueFieldLabel: function (fn, dataField) {
            ...
            if (initSettings.values) {
                for (var k in initSettings.values) {
                    if (initSettings.values[k].dataField == dataField && initSettings.values[k]["function"] == fn) {
        ...
        _populateListBox: function (listBox, fields, fieldType) {
            ...
            for (var i in fields) {
              ...
              if(this._allFields[dataField] != null){
        ...
        _createSettingsWindow: function () {
            var self = this;
            var windowElement = "<div id='pivotFieldSettingsWindow' style='width: 300px; height: 200px;'><table style='width: 100%;'><tr><td style='height: 30px;'>" + self._getLocalizedString("move") + " " + self._getLocalizedString("to") + "</td><td><div style='width: 100%;' class='lbPivotFieldMoveTo'></div></td></tr><tr><td style='height: 30px;'>" + self._getLocalizedString("alignment") + "</td><td><div style='width: 100%;' class='lbAlignment'></div></td></tr><tr class='valueField'><td style='height: 30px;'>" + self._getLocalizedString("calculation") + "</td><td><div style='width: 100%;' class='lbCalculation'></div></td></tr><tr class='valueField'><td style='height: 30px;'>" + self._getLocalizedString("numberformat") + "</td><td></td></tr><tr class='valueField'><td style='height: 30px;'>" + self._getLocalizedString("cellalignment") + "</td><td><div style='width: 100%;' class='lbCellsAlignment'></div></td></tr><tr class='valueField'><td style='height: 30px;'>" + self._getLocalizedString("prefix") + "</td><td><input type='text' style='width: 100%;' class='txtPrefix'></input></td></tr><tr class='valueField'><td style='height: 30px;'>" + self._getLocalizedString("decimalplacestext") + "</td><td><input type='text' style='width: 100%;' class='txtDecimalPlaces'></input></td></tr><tr class='valueField'><td style='height: 30px;'>" + self._getLocalizedString("thousandsseparatortext") + "</td><td><input type='text' style='width: 100%;' class='txtThousandsSeparator'></input></td></tr><tr class='valueField'><td style='height: 30px;'>" + self._getLocalizedString("decimalseparatortext") + "</td><td><input type='text' style='width: 100%;' class='txtDecimalSeparator'></input></td></tr><tr class='valueField'><td style='height: 30px;'>" + self._getLocalizedString("nagativebracketstext") + "</td><td><div style='width: 100%;' class='checkBoxNagativeWithBrackets'></input></td></tr><tr><td style='height: 30px;' colspan=2 align=middle><input class='btnOk' type='button' value='" + self._getLocalizedString("ok") + "'></input><input class='btnCancel' style='margin-left: 10px;' type='button' value='" + self._getLocalizedString("cancel") + "'></input></td></tr></table>";
            ...
            self._settingsWindow = self.host.find("#pivotFieldSettingsWindow").jqxWindow({
                ...
                initContent: function () {
                    ...
                    var btnCancel = self._settingsWindow.find(".btnCancel").jqxButton({
                        width: 80
                    });
                    var btnOk = self._settingsWindow.find(".btnOk").jqxButton({
                        width: 80
                    });
        ...
        _updateWindowData: function () {
            ...
            for (var i in fieldSettings.moveOperations) {
                listBoxData.push({
                    text: i,
                    value: fieldSettings.moveOperations[i]
                })
            }
            var lbMoveTo = self._settingsWindow.find(".lbPivotFieldMoveTo");
            lbMoveTo.jqxDropDownList({
                source: listBoxData,
                displayMember: "text",
                selectedIndex: -1,
                valueMember: "value",
            ...
            var listBoxAlignmentData = listBoxData = [{
                text: self._getLocalizedString("left"),
                value: "left"
            }, {
                text: self._getLocalizedString("center"),
                value: "center"
            }, {
                text: self._getLocalizedString("right"),
                value: "right"
            }];
            var selectedIndex = 0;
            if (sourceBoundItem) {
            ...
            if (fieldSettings.functions) {
                ...
                var lbCellsAlignment = self._settingsWindow.find(".lbCellsAlignment");
                lbCellsAlignment.jqxDropDownList({
                    source: listBoxData,
                    selectedIndex: selectedIndex,
                    displayMember: "text",
                    valueMember: "value",
                ...
                inputThousandsSeparator.jqxInput({
                ...
                inputDecimalSeparator.jqxInput({
        ...
        _createFiltersWindow: function () {
            ...
            self._filtersWindow = self.host.find("#pivotFieldFiltersWindow").jqxWindow({
                ...
                initContent: function () {
                    ...
                    var btnCancel = self._filtersWindow.find(".btnCancel").jqxButton({
                        width: 80
                    });
                    var btnOk = self._filtersWindow.find(".btnOk").jqxButton({
                        width: 80
                    });
                    btnCancel.on("click", function () {
