...
(function($) {
                ...
                $element.children().each(function(i, el) {
                    ...
                    if ('optgroup' == $el.prop('nodeName').toLowerCase()) {
                        ...
                        if (0 < $this.idx || '' != val || ! $this.settings.multiple) {
                            ...
                            var row = '<div  class="fs-option' + selected + disabled + group + classes + '" data-value="' + val + '" data-index="' + $this.idx + '"><span class="fs-checkbox" id="'+options['columnName']+'_' + $this.idx + '" data-slect-grid-id="'+options['gridId']+'" data-select-column-name="'+options['columnName']+'"><i></i></span><div class="fs-option-label">' + $el.html() + '</div></div>';
    ...
    $(document).on('click', '.fs-option:not(.hidden, .disabled)', function(e) {
        ...
        var selectBoxId =  $select.attr("id");
        var filterGridFlagCount =$select.attr("data-filtergridflag-count"); //data-filtergridflag-count
        var operatorId = "operator" + $("#" + selectBoxId).attr("data-viewid") + filterGridFlagCount;
