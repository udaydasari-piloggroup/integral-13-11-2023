            ...
            if (this.options.canUserMoveOperators) {
                ...
                fullElement.operator.draggable({
                    ...
                    stop: function (e, ui) {
						...
						var divId = ui.helper[0];
						var height = '40px';
						if (divId != null && divId != '' && divId != undefined) {
							var parentDivId = $(divId).parent().parent().attr("id");
							if (parentDivId != null && parentDivId != '' && parentDivId != undefined && parentDivId == 'userMergeTableColumnsDivId') {
								height = "auto";
							}
						}
						operatorChangedPosition(operatorId, ui.position);
...
//              linkData.internal.els.path.parent.attr("title","test");
        ...
        getAllToOperatorsByFromOpId: function (selectedFromOperatorId) {
            var data = {};
